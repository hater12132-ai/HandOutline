...
inline constexpr std::string_view Description = "WireOutline targets hand/items/armor/players/crystals 1.10.1.";
inline constexpr std::string_view Version = "1.10.1";
